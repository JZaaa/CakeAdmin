...
class ArctypesController extends AppController
{
    ...
    public function index()
    {
        ...
        $colorData = $this->Arctypes->colorData();
    ...
    public function add($parent_id = null)
    {
        ...
        $stateData = $this->Arctypes->stateData();     //状态
        $bool = getBool();
        $enable_columns = $this->Arctypes->selectColumns();

        $this->set(compact('typeData', 'stateData', 'bool', 'enable_columns'));
    }
    ...
    public function edit($id = null)
    {
        ...
        $this->set(compact('data', 'typeData', 'stateData', 'bool', 'enable_columns'));
    }
