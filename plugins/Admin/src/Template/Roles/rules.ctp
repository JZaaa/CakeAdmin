...
<div class="bjui-pageContent">
    <form action="<?php echo $this->Url->build(['plugin' => $this->request->params['plugin'], 'controller' => 'Roles', 'action' => 'rules', $id]);?>" class="pageForm" data-toggle="validate" data-reloadNavtab="ture" >
        <input type="hidden" name="rules" id="rules" value="<?php echo $haveRuleStr;?>">
